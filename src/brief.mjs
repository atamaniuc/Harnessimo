...
/**
 * @param {object} input
 * @param {string | null} input.tracksText      contents of the track index
 * @param {{ path: string, text: string }[]} input.handoffs
 * @param {object | null} input.queue           the parsed feature list
 * @param {string | null} input.progressText
 * @param {Record<string, boolean>} input.enabled  which checks are configured
 * @param {string} [input.tracksPath]
 * @returns {string}
 */
