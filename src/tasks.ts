...
import { checkTarget, isSyntaxExample } from "./proof.ts";
 ...
 *
 */
export function verifyTaskGates(files: { path: string, text: string }[], tracksText: string, resolver: Resolver, options: { specsDir?: string, taskFile?: string } = {}): Problem[] {
