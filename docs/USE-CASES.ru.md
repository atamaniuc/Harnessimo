...
**Кому это?** Тому, кто спрашивает, что именно это поймает в его репозитории.
**Когда читать?** На этапе оценки — здесь настоящий вывод команд, а не макеты.
Убедились? Отсчёт начинается в [гайде](GUIDE.ru.md).
