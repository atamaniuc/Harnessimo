...
[![docs](https://img.shields.io/badge/docs-atamaniuc.github.io%2FHarnessimo-blue)](index.md)
...
Details: [Adopting an existing repo](ADOPTING.md).
...
- [15-minute guide](GUIDE.md) · [по-русски](GUIDE.ru.md)
...
[MIT](https://github.com/atamaniuc/Harnessimo/blob/main/LICENSE). Fork it, vendor it, ship it commercially. If you improve a rule, send a PR —
