...
**Кому это?** Тому, кто решает, внедрять ли, ещё не открыв терминал.
**Когда читать?** До установки — здесь аргументы и честный ответ, когда это не нужно.
Уже решили? Вам в [гайд](GUIDE.ru.md).
...
## Настроить один раз — дальше работает без вас

Три хука и одна строка в CI, настраиваются однажды:
...
| **Claude Code, Codex, Cursor, Gemini CLI** | сам *механизм* харнеса: хуки, файлы инструкций, доступ к инструментам | они дают механизм, а не правила; что именно проверять — ваша забота | одиннадцать правил, которые стоит проверять, и их проводка |
...
**Он живёт по собственному стандарту.** Десять из одиннадцати применяются к этому репозиторию,
...
**У каждого правила есть тест, доказывающий срабатывание на плохом входе.**
...
Дальше: [гайд за 15 минут](GUIDE.md) · [как это выглядит на практике](REFERENCE.md) ·
