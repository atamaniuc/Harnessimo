...
| **Claude Code, Codex, Cursor, Gemini CLI** | сам *механизм* харнеса: хуки, файлы инструкций, доступ к инструментам | они дают механизм, а не правила; что именно проверять — ваша забота | девять правил, которые стоит проверять, и их проводка |
...
**Он живёт по собственному стандарту.** Все девять проверок применяются к этому репозиторию,
