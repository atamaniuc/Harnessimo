...
1. **Spec 0003, doc contracts — phases 1 and 2 shipped, phase 3 open.** Every page now
   ...
   this repository actually had. Phase 3 is the configuration reference (nine config
   sections, no page documents them) and a generated `llms.txt` for the one reader profile
   with nothing addressed to it.
