...
Их восемь. Включаете те, что нужны. Они работают в CI и перед каждым коммитом, и падают с
...
Этот репозиторий применяет все восемь проверок к себе, в том числе из свежего клона.
<!-- proof: npm run check -->
