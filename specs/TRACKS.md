...
- **More than one agent (spec 0006)** — [handoff](specs/0006-parallel-agents/handoff.md) — active, 2026-09-08, next: write the acceptance criteria, then the first failing test
